...
array_push($mainaccounts,"yyananoreen_1995");
array_push($mainaccounts,"bev_esteban2019");
array_push($mainaccounts,"bbeeaa02");
...
print "$White\na )$Green raters > main accounts";
print "$White\nb )$Green raters > other account";
print "$White\nc )$Green main > main accounts";
print "$White\nd )$Green main > other accounts";
print "$White\ne )$Green other > other account";
print "$White\nf )$Green back to main";
print "$White\n-----------------------------\n";
